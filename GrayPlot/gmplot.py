...
class GoogleMapPlotter(object):
    ...
    def __init__(self, center_lat, center_lng, zoom, apikey='--GOOGLE MAPS API KEY HERE--'):
    ...
    def geocode(self, location_string):
        geocode = requests.get(
            'https://maps.googleapis.com/maps/api/geocode/json?address="%s"&key=--GOOGLE MAPS API KEY HERE--' % location_string)
